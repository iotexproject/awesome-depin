...
- [RustChain](https://github.com/Scottcjn/Rustchain) — hardware-attested DePIN network that rewards physical compute participation across vintage and unusual CPU architectures.
